...
<p align="center">
  <img src="images/selfgeo_overview.gif" alt="over_view" width="700"/>
  <img src="images/geodesic_loss.gif" alt="geodesic_loss" width="350"/> 
  <img src="images/temporal_loss.gif" alt="temporal_loss" width="350"/> 
</p>
...
The remaining categories can be added to the same folder.
...
which could be generated by running the "sdk.py" (as discussed in the dataset section).
